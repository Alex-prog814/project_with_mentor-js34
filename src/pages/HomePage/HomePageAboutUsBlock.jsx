...
import styles from "./homepageAboutUsBlock.module.css";
import aboutUSImg from "./img/aboutus__img.svg";
import aboutUsIconFirst from "./img/aboutus-icon1.svg";
import aboutUsIconSecond from "./img/aboutus-icon2.svg";
import aboutUsBtnIcon from "./img/aboutus-btn-arrow.svg";
        ...
        <div className={styles.aboutus__right__block}>
          ...
          >
            ...
            <img
              src={aboutUsBtnIcon}
              alt="error"
              className={styles.aboutus__right__block__button__img}
            />
          </button>
        </div>
      </div>
